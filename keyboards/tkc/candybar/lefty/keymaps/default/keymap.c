...
[_BL] = LAYOUT(
  ...
  KC_P1 , KC_P2,  KC_P3  ,STARPSCR, KC_LSFT,            KC_Z   , KC_X,   KC_C, KC_V  , KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_UP  ,      LT(_FD,KC_SLSH), \
  KC_P0,  KC_P0,  KC_PDOT,KC_PENT,  LT(_FUNCTION,KC_NUHS),KC_LGUI,KC_LALT,KC_SPC,LT(_SYMBOLS,KC_SPC),KC_SPC, LT(_SYMBOLS,KC_QUOTE),KC_LEFT, KC_DOWN, KC_RGHT),
...
[_ALPHA] = LAYOUT(
  KC_P7 , KC_P8,  KC_P9  ,KC_MINS,  KC_ESC ,            KC_Q   , KC_W  , KC_E, KC_R  , KC_T, KC_Y, KC_U, KC_I   , KC_O  , KC_P   ,KC_NUBS,         KC_RBSP , \
  KC_P4 , KC_P5,  KC_P6  ,REVPLUS,  MT(MOD_LCTL,KC_TAB),KC_A   , KC_S  , KC_D, KC_F  , KC_G, KC_H, KC_J, KC_K   , KC_L  , KC_SCLN,                  KC_ENT  , \
  KC_P1 , KC_P2,  KC_P3  ,STARPSCR, KC_LSFT,            KC_Z   , KC_X,   KC_C, KC_V  , KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH  ,      LT(_FD,KC_SLSH),          \
  KC_P0,  KC_P0,  KC_PDOT,KC_PENT,  LT(_FUNCTION,KC_NUHS),KC_LGUI,KC_LALT,KC_SPC,LT(_ASYMBOLS,KC_SPC),KC_SPC, LT(_ASYMBOLS,KC_QUOTE),MT(MOD_RALT,KC_LBRC),LT(_SYMBOLS,KC_QUOTE/*KC_APP*/),MT(MOD_RCTL,KC_RBRC)),
...
[_FD] = LAYOUT(
  ...
  KC_F4 , KC_F5,  KC_F6 , KC_F12,  KC_LCTL, KC_WH_U, KC_SLCK, TO(_BL), XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_QUOT,          KC_BRK , \
  KC_F1 , KC_F2,  KC_F3 , KC_PSCR, KC_LSFT, KC_WH_D, XXXXXXX, KC_CALC, XXXXXXX, XXXXXXX, KC_NLCK, XXXXXXX, XXXXXXX, KC_PDOT, KC_MS_U,   KC_RSFT , \
  KC_F10, KC_F10, KC_BRK, KC_SLCK, _______, KC_APP,  KC_LALT,                KC_MS_BTN1,     KC_MS_BTN1 , KC_MS_BTN2,KC_RALT, KC_MS_L, KC_MS_D, KC_MS_R),

  /* Keymap _FUNCTION: Function keys Layer
  */
[_FUNCTION] = LAYOUT(
  KC_HOME, KC_UP,  KC_PGUP, KC_PMNS,KC_GRV  ,XXXXXXX,XXXXXXX,TO(_BL),RESET,XXXXXXX,XXXXXXX,XXXXXXX,KC_INS, KC_POWER,KC_PSCR,KC_DEL,KC_DEL , \
  KC_LEFT, XXXXXXX,KC_RIGHT,KC_PPLS,MT(MOD_LCTL,KC_CAPS),TO(_ALPHA), KC_SLCK, TO(_BL), XXXXXXX, XXXXXXX, XXXXXXX,XXXXXXX,XXXXXXX, XXXXXXX, KC_QUOTE, KC_BRK, \
  KC_END,  KC_DOWN,KC_PGDN, KC_CALC,KC_LSFT,          RGB_TOG, RGB_MOD, RGB_HUI, RGB_VAI,  KC_PAUS, KC_NLCK, XXXXXXX,XXXXXXX, XXXXXXX, KC_PGUP, KC_RSFT , \
...
[_SYMBOLS] = LAYOUT(
  ...
  S(KC_0), S(KC_0),   S(KC_SLSH),KC_CALC, KC_LCTL, KC_APP,  KC_LALT,                KC_SPC,  KC_SPC , KC_SPC,_______ ,KC_LBRC,KC_QUOTE,KC_RBRC),
