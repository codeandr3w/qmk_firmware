...
[0] = LAYOUT_all( /* Base */
    KC_F1, KC_F2,     KC_GRAVE,KC_1,    KC_2,   KC_3,   KC_4,   KC_5,   KC_6,   KC_7,   KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_NUBS, KC_BSPC,   LT(1,KC_ESC),  KC_NUM_LOCK, KC_SCROLL_LOCK, KC_PSCR,
    ...
    KC_F9, KC_F10,    KC_LALT,      KC_LALT,                        KC_SPC,                                    KC_RALT,          MT(MOD_RALT,KC_CAPS),            KC_P0,   KC_P00,  KC_PDOT, KC_PPLS),
...
[1] = LAYOUT_all( /* FN */
    ...
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_WAKE, XXXXXXX, QK_BOOT, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_PWR,  XXXXXXX, KC_MS_U, XXXXXXX, XXXXXXX,             XXXXXXX, KC_MS_U, KC_WH_U, KC_PSCR,
    XXXXXXX, XXXXXXX, KC_LCTL, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_MS_L, KC_MS_R,          KC_MS_BTN2,          KC_MS_L, XXXXXXX, KC_MS_R, KC_PSLS,
    XXXXXXX, XXXXXXX, KC_TRNS, XXXXXXX, KC_VOLU, KC_VOLD, KC_MUTE, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_MS_D, KC_TRNS, KC_TRNS,             XXXXXXX, KC_MS_D, KC_WH_D, XXXXXXX,
    KC_LGUI, KC_RGUI, KC_LALT,          KC_TRNS,                            KC_MS_BTN1,                                  KC_RALT,          KC_RALT,             XXXXXXX, XXXXXXX, XXXXXXX, KC_PENT),

[2] = LAYOUT_all( /* Base for 7u */
    KC_F1, KC_F2,     KC_GRAVE,KC_1,    KC_2,   KC_3,   KC_4,   KC_5,   KC_6,   KC_7,   KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_NUBS, KC_BSPC,   KC_ESC,  KC_NUM_LOCK, KC_SCROLL_LOCK, LT(3,KC_PSCR),
    KC_F3, KC_F4,     KC_TAB,  KC_Q,    KC_W,   KC_E,   KC_R,   KC_T,   KC_Y,   KC_U,   KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_NUHS,            KC_P7,   KC_P8,   KC_P9,   KC_PAST,
...
[3] = LAYOUT_all( /* Mod for 7u */
    ...
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, QK_BOOT, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_MS_U, XXXXXXX, XXXXXXX,             XXXXXXX, XXXXXXX, XXXXXXX, KC_PSCR,
