...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_ALPHA] = LAYOUT(
    ...
    KC_3,MT(MOD_LGUI,KC_4),MT(MOD_LALT,KC_5),LT(_FNL,KC_SCOLON),KC_SPC,KC_SPC,LT(_SYMBOLS,KC_QUOTE),MT(MOD_RALT,KC_6),KC_7,KC_8
  ),
  ...
  [_FNL] = LAYOUT(
    KC_GRV,  TO(_QAZ),XXXXXXX, TO(_EDIT), XXXXXXX, KC_HOME,   KC_PGUP,XXXXXXX,  XXXXXXX,   KC_LBRC,  KC_RBRC, KC_DEL,
    ...
    OSL(_ALPHAH),OSM(MOD_LGUI),OSM(MOD_LALT),_______, KC_SPC,KC_SPC, OSM(MOD_RALT),      KC_LEFT,  KC_DOWN, KC_RIGHT 
  ),
  ...
  [_FUNCTION] = LAYOUT(
    ...
    KC_F3,   KC_F4,   KC_F5,   KC_LALT, KC_SPC,  KC_SPC, KC_RALT,                   KC_6,    KC_7,   KC_8
 ),
  ...
  [_SYMBOLS] = LAYOUT(
    ...
    S(KC_MINS),S(KC_1),   S(KC_2),   S(KC_3),   S(KC_4),   S(KC_5),   S(KC_6),   S(KC_7),       S(KC_8), S(KC_9), S(KC_0), 
  ...
  [_EDIT] = LAYOUT(
    LT(_ALPHAH,KC_ESC),KC_Q,KC_W,KC_E,   KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_BSPC,
    MT(MOD_LCTL,KC_TAB),  KC_A,   KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_ENT,
    KC_LSHIFT,KC_NUBS,KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMMA,KC_UP,   MT(MOD_RSFT,KC_SLASH),
    LT(_FNL,KC_NUHS),KC_LGUI,KC_LALT,LT(_FNL,KC_SCOLON),KC_SPC,KC_SPC,  LT(_SYMBOLS,KC_QUOTE),KC_LEFT, KC_DOWN, KC_RIGHT
 )
};
...
static enum KCOL_KEYTYPES fn1types [] = {
  KCOL_SYMBOL, KCOL_LAYER, KCOL_BLANK, KCOL_LAYER, KCOL_BLANK, KCOL_MOD, KCOL_MOD, KCOL_BLANK, KCOL_BLANK, KCOL_SYMBOL, KCOL_SYMBOL, KCOL_MOD,
  ...
  KCOL_LAYER, KCOL_MOD, KCOL_MOD, KCOL_LAYER, KCOL_ALPHA, KCOL_ALPHA, KCOL_MOD, KCOL_FN, KCOL_FN, KCOL_FN
  };
