...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_DEFAULT] = LAYOUT(
    ...
    MT(MOD_LSFT,KC_1),KC_2,KC_Z,   KC_X,    KC_C,     KC_V,    KC_B,    KC_N,    KC_M,   KC_COMM, KC_9,    LT(_MOUSE,KC_0),
  ...
  [_FNC] = LAYOUT(
    KC_GRV,  TO(_QAZ),XXXXXXX, TO(_EDIT), RESET,    XXXXXXX,  XXXXXXX, XXXXXXX, KC_INS,   KC_POWER,  KC_PSCR, KC_DEL,
    MT(MOD_LCTL,KC_CAPS), TO(_ALPHA), TO(_SYMBOLS), TO(_DEFAULT),XXXXXXX,XXXXXXX,XXXXXXX,  XXXXXXX, XXXXXXX,  XXXXXXX,  KC_NUHS,
  ...
  [_MOUSE] = LAYOUT(
    ...
    KC_LSFT, XXXXXXX, KC_WH_D, XXXXXXX, XXXXXXX, XXXXXXX, KC_BRK,  XXXXXXX, KC_MUTE, XXXXXXX, KC_MS_U, _______,
  ...
  [_SYMBOLS] = LAYOUT(
    ...
    S(KC_MINS),S(KC_1),   S(KC_2),   S(KC_3),   S(KC_4),   S(KC_5),   S(KC_6),   S(KC_7),       S(KC_8), S(KC_9), KC_SCLN, 
    KC_LSHIFT,KC_NUBS,  XXXXXXX,   XXXXXXX,   XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX, XXXXXXX, XXXXXXX, KC_DOT, KC_SLSH,
    KC_NUHS,KC_LGUI,KC_LALT, KC_SCLN,KC_LSHIFT,KC_SPC, MO(_SYMBOLS),                         KC_LBRC,KC_QUOTE,KC_RBRC
 ),
  ...
  [_ALPHA] = LAYOUT(
    ...
    MT(MOD_LCTL,KC_TAB),  KC_A,   KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_ENT,
    KC_LSHIFT,KC_NUBS,KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMMA,KC_DOT,   LT(_MOUSE,KC_SLASH),
  ...
  [_EDIT] = LAYOUT(
    LT(_DEFAULTH,KC_ESC),KC_Q,KC_W,KC_E,   KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_BSPC,
    MT(MOD_LCTL,KC_TAB),  KC_A,   KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_ENT,
    KC_LSHIFT,KC_NUBS,KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMMA,KC_UP,   LT(_MOUSE,KC_SLASH),
...
static enum KCOL_KEYTYPES fn1types [] = {
  KCOL_SYMBOL, KCOL_LAYER, KCOL_BLANK, KCOL_LAYER, KCOL_FN, KCOL_BLANK, KCOL_BLANK, KCOL_BLANK, KCOL_MOD, KCOL_FN, KCOL_MOD, KCOL_MOD,
  KCOL_MOD, KCOL_LAYER, KCOL_LAYER, KCOL_LAYER, KCOL_BLANK, KCOL_BLANK, KCOL_BLANK, KCOL_BLANK, KCOL_BLANK, KCOL_BLANK, KCOL_SYMBOL,
...
static enum KCOL_KEYTYPES mousetypes [] = {
  KCOL_FN, KCOL_FN, KCOL_FN, KCOL_FN, KCOL_FN, KCOL_FN, KCOL_FN, KCOL_FN, KCOL_FN, KCOL_FN, KCOL_FN, KCOL_FN,
