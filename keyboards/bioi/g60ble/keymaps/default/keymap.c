...
[1] = LAYOUT_all(
    ...
    LCTL_T(KC_CAPS),KC_A,KC_S, KC_D,    KC_F,    KC_G,    KC_LEFT, KC_UP,   KC_DOWN, KC_RIGHT,KC_LEFT, KC_RIGHT,XXXXXXX, KC_PENT,
...
[2] = LAYOUT_all(
    ...
    LCTL_T(KC_CAPS),KC_A,KC_S, KC_D,    KC_F,    KC_G,    KC_HOME, KC_PGUP, KC_PGDN, KC_END,  KC_MS_L, KC_MS_R, XXXXXXX, KC_PENT,
